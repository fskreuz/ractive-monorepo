...
import { backboneModel, backboneCollection } from '@ractivejs/adaptor-backbone'

QUnit.module('ractive-adaptor-backbone collections')

QUnit.test('Adaptor can detect collections', t => {
  t.ok(backboneCollection.filter(new Backbone.Collection()))
})
...
QUnit.test('Initialize with pre-filled collection', t => {
  ...
  const instance = Ractive({
    adapt: [ backboneCollection, backboneModel ],
    data: { collection },

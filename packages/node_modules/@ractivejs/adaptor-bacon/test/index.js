...
import {bacon} from '@ractivejs/adaptor-bacon'

QUnit.module('adaptor-bacon')

QUnit.test('Adaptor can detect an observable', t => {
  t.ok(bacon.filter(new Bacon.Observable('foo')))
  t.ok(bacon.filter(new Bacon.EventStream(() => {})))
  t.ok(bacon.filter(new Bacon.Property('prop', () => {})))
  t.ok(bacon.filter(new Bacon.Bus()))
})

...
import { ampersandModel } from '@ractivejs/adaptor-ampersand'

QUnit.module('adaptor-ampersand models')

Ractive.DEBUG = false

QUnit.test('Adaptor can detect models', t => {
  t.ok(ampersandModel.filter(new Model()))
})
...
QUnit.test('Resetting model with a new MyModel', t => {
  const MyModel = Model.extend({ props: { message: 'string' } })

...
const loadComponent = (base, dependent, dependency, map) => {
  ...
  const srcName = resolvedPath
  const destName = replaceExtension(resolvedPath, '.js')
  return constructors[resolvedPath] || (constructors[resolvedPath] = toConstructor({ srcName, destName, parts, resolver }))
}
